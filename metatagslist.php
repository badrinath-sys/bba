		...
		<!-- //header-ends -->
				...
				<div class="col-md-12">
					<ul class="breadcrumb bre-bg">
						<li><a href="#">Date Module</a></li>
						<li class="active">Meta Tags</li>
					</ul>
				</div>
				<form action="<?php echo base_url()."index.php/Welcome/tagreport" ?>">
				
				<div class="col-md-12 mb-10">
				<div class="card-header">Meta Tags Reports  <span class="pull-right"><a href="javascript:void(0)" onclick="fnmeta()" data-toggle="tooltip" data-placement="top" title="Back to Page"><i class="lnr lnr-arrow-left  add-icon"></i></a></span></div>
				<div class="card-body">
...
-->
        ...
        <!--footer section start-->
			<footer>
			   <p>&copy 2018 All rights reserved by  <a href="#">Margadarsi Computers.</a></p>
			</footer>
        <!--footer section end-->
