                         ...
                         <li class="active"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-tags"></i><span class="hide-menu">Meta Tags </span></a>
                            <ul aria-expanded="false" class="collapse">
                                 <li><a href="javascript:void(0)"  onclick="fnmetatag()">Meta Tags Entry</a></li>   
                                  <li><a href="javascript:void(0)" class="active" onclick="fntagreport()">Meta Tags Report</a></li>                               
                            </ul>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h5 class="text-primary">Meta Tags Report</h5> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Meta Tags</a></li>
                        <li class="breadcrumb-item active">Meta Tags Reports</li>
            ...
            <!-- Container fluid  -->
                        ...
                        <form action="<?php echo base_url() . "index.php/Welcome/contreport"?>" name="contrep" id="contrep" method="post">
