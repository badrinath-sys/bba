            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="javascript:void(0)" class="active" onclick="fnvideogalleryreport()">Videogallery Report</a></li>
                    </ul>
                </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h5 class="text-primary">Video Gallery Report</h5> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">VideoGallery</a></li>
                        <li class="breadcrumb-item active">Video Gallery Reports</li>
                            ...
                            <div class="card-body">
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                                  foreach($videorep as $k=>$v){

                                                    $path=base_url()."assets/images/videogallery/".$v['image_path']
                                                    ?>
                                            <tr>      
