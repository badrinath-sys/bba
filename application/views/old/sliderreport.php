                         ...
                         <li class="active"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-camera-retro"></i><span class="hide-menu">Sliders </span></a>
                            <ul aria-expanded="false" class="collapse">
                               <li><a href="javascript:void(0)" onclick="fnslider()">Sliders Entry</a></li>   
                                  <li><a href="javascript:void(0)" class="active" onclick="fnsliderreport()">Sliders Report</a></li>                             
                            </ul>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h5 class="text-primary">Sliders Report</h5> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Sliders</a></li>
                        <li class="breadcrumb-item active">Sliders Reports</li>
            ...
            <!-- Container fluid  -->
                        ...
                        <form action="<?php echo base_url() . "index.php/Welcome/sliderreport"?>" name="sliderep" id="sliderep" method="post">
                                        ...
                                        <tbody>
                                            <?php
                                                  foreach($contrep as $k=>$v){
                                                    $path=base_url()."assets/images/sliders/".$v['path']
                                                    ?>
                                            <tr>      
                                                 
                          <td><?php echo $v['pages'];?> </td>
                           <td><?php echo $v['dt'];?> </td>
                           <td><?php echo $v['link'];?> </td>
                           <td> <a href="#"><img id="img1" name="img1" src="<?php echo $path ?>" class="img-responsive"></a>
