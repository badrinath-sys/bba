                        ...
                        <li class="active"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-calendar"></i><span class="hide-menu">Daily Tips </span></a>
                            <ul aria-expanded="false" class="collapse">
                                 <li><a href="javascript:void(0)" onclick="fndailytips()">Daily Tips Entry</a></li>  
                                   <li><a href="javascript:void(0)" class="active" onclick="fndailyreport()">Daily Tips Report</a></li>  
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h5 class="text-primary">Daily Tips Report</h5> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Daily Tips</a></li>
                        <li class="breadcrumb-item active">Daily Tips Reports</li>
            ...
            <!-- Container fluid  -->
                        ...
                        <form action="<?php echo base_url() . "index.php/Welcome/dailyreport"?>" name="contrep" id="contrep" method="post">
