                      ...
                      <!--   <li> <a class="has-arrow " href="#" aria-expanded="false"><i class="fa fa-image"></i><span class="hide-menu">Gallerys</span></a>
                        ...
                        <li class="active"> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">Contributors</span></a>
                            <ul aria-expanded="false" class="collapse">
                                 ...
                                 <li><a href="javascript:void(0)" class="active" onclick="fncontreport()">Contributors Report</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h5 class="text-primary">Contributor Report</h5> </div>
            ...
            <!-- Container fluid  -->
                        ...
                        <div class="col-lg-12">
                          ...
                          <td><?php echo $v['code'];?> </td>
                           ...
                           <td><?php echo $v['bankacc'];?> </td>
                           <td><?php echo $v['ifsc'];?> </td>
                           <td><?php echo $v['dt'];?> </td>
                       </tr>
