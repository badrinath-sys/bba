    ...
    <body class="fix-header fix-sidebar">
        ...
        <div id="main-wrapper">
                ...
                <nav class="navbar top-navbar navbar-expand-md navbar-light">
                    ...
                    <div class="navbar-collapse">
                        ...
                        <ul class="navbar-nav mr-auto mt-md-0">
                            ...
                            <!-- Messages -->
                            <li class="nav-item"> <a data-toggle="collapse" class="nav-link dropdown-toggle text-muted" href="#collapseExample"  aria-haspopup="true" aria-expanded="false"><i class="fa fa-filter"></i></a>   
                            </li>
                            <!-- End Messages -->
                        </ul>
            ...
            <div class="left-sidebar">
                ...
                <!--logos-->
                <div class="mahila_bharat logo-cont"><img src="images/logo.png"  width="40%"></div>
                <div class="health logo-cont"><img src="images/health-logo.png" width="40%"></div>
                <div class="yong_bharat logo-cont"><img src="images/young-bharat.png" width="40%"></div>
                <div class="bala_bharat logo-cont"><img src="images/logo.png" width="40%"></div>
                ...
                <form action="#">
                    <div class="col-md-12 animated zoomIn collapse"  id="collapseExample">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-right" style="padding-right:120px;">
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h5 class="text-primary">Dashboard</h5> </div>
                                    ...
                                    <div class="row p-t-20">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="inp-container">
                                                    <select class="form-control">
                                                        <option id="assamese" value="assamese"> Assamese </option>
                                                        <option id="bengali" value="bengali"> Bengali </option>
                                                        <option id="english" value="english" selected> English </option>
                                                        <option id="gujarati" value="gujarati"> Gujarati</option>
                                                        <option id="hindi" value="hindi"> Hindi </option>
                                                        <option id="kannada" value="kannada"> Kannada </option>
                                                        <option id="malayalam" value="malayalam"> Malayalam</option>
                                                        <option id="marathi" value="marathi"> Marathi</option>
                                                        <option id="oriya" value="oriya"> Oriya </option>
                                                        <option id="punjabi" value="punjabi"> Punjabi </option>
                                                        <option id="tamil" value="tamil"> Tamil </option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">Group  <span class="sub-text">Category</span></label>
                                                <div class="clearfix"></div>
                                                <select class="example-enableFiltering-includeSelectAllOption" multiple="multiple" id="maincatg">
                                                    <option value="1">Option 1</option>
                                                    <option value="2">Option 2</option>
                                                    <option value="3">Option 3</option>
                                                    <option value="4">Option 4</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label">Select <span class="sub-text">Gender</span></label>
                                                <div class="clearfix"></div>
                                                <div class="float-left gender-box"><input type="radio" name="gender"><i class="fa fa-male fa-1x fa-mr"></i></div>
                                                <div class="float-left gender-box"><input type="radio" name="gender"><i class="fa fa-female fa-1x fa-mr"></i></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="clearfix"></div>
                                                <div class="inp-container">
                                                    <input type="text" name="age-grp" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="art-tit-eng" class="form-control">
                                            </div>
                                        </div>

                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Article Title <span class="sub-text">(Telugu)</span></label>
                                                <div id="title"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="video-link-main">
                                                <div class="video-link-cont">
                                                    <input type="text" name="links" class="form-control" placeholder="Facebook link....">
                                                </div>
                                                <div class="img-add-cont">
                                                    <div class="pull-left mr-r"><button class="btn btn-dark"><i class="fa fa-plus"></i></button></div>
                                                    <div class="pull-left"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></div>
                                        ...
                                        <div class="col-md-12 mr-b mr-t">
                                            ...
                                            <div class="tags-link-main">
                                                <div class="tags-link-cont">
                                                    <input type="text" name="links" class="form-control" placeholder="health, yogo..">
                                                </div>
                                                <div class="img-add-cont">
                                                    <div class="pull-left mr-r"><button class="btn btn-dark"><i class="fa fa-plus"></i></button></div>
                                                    <div class="pull-left"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></div>
                                        ...
                                        <div class="col-md-4 mr-b mr-t">
                                            <label class="control-label">Author / <span class="sub-text">Selection</span></label>
                                            <select class="form-control">
                                        ...
                                        <div class="col-md-4 mr-b mr-t">
                                            <label class="control-label">Emp / <span class="sub-text">Code</span></label>
                                            <input type="text" name="emp-code" class="form-control">
                                        </div>

                                        <div class="col-md-4 mr-b  mr-t">
                                            <label class="control-label">Author / <span class="sub-text">Name</span></label>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                //For main Category Data Loading
                
               $.ajax({
                type:'POST',
                url:'<?php echo base_url('index.php/Welcome/getcatg'); ?>',
                data:'id=1',
                success:function(data){
                   console.log(data);
                    //$('#maincatg').html('<option value="">Select Category</option>'); 
                    ...
                    if(dataObj){
                        ...
                        $(dataObj).each(function(){
                            ...
                            option.attr('value', this.id).text(this.name);           
                             alert(option.attr('value', this.id).text(this.name));           
                            alert("opt"+option);
                            console.log("opt"+option);
                            $('#maincatg').append(option);
                            
                            $('#maincatg').multiselect('rebuild');
                            
                        });
                    }else{
                        $('#maincatg').html('<option value="">Maincatg not available</option>');
                    }
