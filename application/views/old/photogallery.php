        ...
        <div class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="javascript:void(0)" class="active" onclick="fnphotogallery()">Photo Gallery</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h5 class="text-primary">Photo Gallery</h5> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Photo Gallery</a></li>
                        <li class="breadcrumb-item active">Photo Gallery Entry</li>
            ...
            <!-- End Bread crumb -->
				...
				<!--filters--> 
						...
						<div class="col-lg-12">
                            ...
                            <div class="card-body">
                               <form action="<?php echo base_url() . "index.php/Welcome/photogallerys" ?>" class="form-horizontal" name="frmarticle" id="frmarticle" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                                    <div class="form-body">
                                        <?php
                                        $dat=$this->session->flashdata('thumbphoto_status');
                                        print_r($dat);
                                        ?>
                                        <div class="row p-t-20">
                                         	...
                                         	<div class="col-md-4 mr-b">
                                           	 <label class="control-label">Image <span class="sub-text">Title</span></label>
											...
											<div class="img-inp-cont">
                                                ...
                                                <input type="file" name="newfile[]" id=newfile[] class="file-control" required> <!--<input type="button" class="btn btn-dark btnAdd" value="Add"><br>-->                        
											...
											<label for="file-8"><span></span> <strong><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> Image Upload &hellip;</strong></label> -->
                                           	...
                                           	<div class="col-md-12 mr-b">
                                           		<label class="control-label">Bulk <span class="sub-text">( Photos )</span> </label>
												<div class="file-loading">
                                                    <input type="file" name="bulkimage[]" id=file-es class="file-control" required>
												</div>
                                           	</div>
