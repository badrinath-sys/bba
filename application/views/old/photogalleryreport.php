            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="javascript:void(0)" class="active" onclick="fnphotogalleryreport()">Photogallery Report</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h5 class="text-primary">Photo Gallery Report</h5> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">PhotoGallery</a></li>
                        <li class="breadcrumb-item active">Photo Gallery Reports</li>
            ...
            <!-- Container fluid  -->
                        ...
                        <form action="<?php echo base_url() . "index.php/Welcome/photogalleryreport"?>" name="photorep1" id="photorep1" method="post">
                            ...
                            <div class="card-body">
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                                  foreach($photorep as $k=>$v){

                                                    $path=base_url()."assets/images/photogallery/".$v['image_path'];
                                                     $path1=base_url()."assets/images/photogallery/".$v['bulk_image_path']
                                                    ?>
                                            <tr>      
                                                 
                          <td><?php echo $v['title'];?> </td>
                          <td><?php echo $v['foldername'];?> </td>
                           <td> <a href="#"><img id="img1" name="img1" src="<?php echo $path ?>" class="img-responsive"></a></td>
                           <td> <a href="#"><img id="img1" name="img1" src="<?php echo $path1 ?>" class="img-responsive"></a></td>
                          <td><?php echo $v['keyword'];?> </td>
                          <td><?php echo $v['entryby'] .$v['entrydate'];?> </td>
                       </tr>
