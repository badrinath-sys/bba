                ...
                <div class="my-info">
                    ...
                    <div class="smline"></div>
                     <div class="row rnd-pd">
                        <form action="<?php echo base_url() . "Lesson/savelesson"; ?>" class="form-horizontal" name="frmsubcatg" id="frmsubcatg" method="post" accept-charset="utf-8">
                            <div class="row pt-3">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input class="form-control" type="text" name="lesson_name" id="lesson_name" placeholder="Lesson Name" required="">
                            </div>

                            <div class="col-md-3 mb-3">
                                <label>Lesson Description</label>
                                <input class="form-control" type="text" name="lesson_description" id="lesson_description"  placeholder="Lesson Description" required="">
                            </div>
                             <div class="col-md-3 mb-3">
                                <label>Total Lessons</label>
                                <input class="form-control" type="text" name="total_lessons" id="total_lessons" placeholder="Total Lessons" required="" readonly="">
                            </div>
                            <div class="col-md-3 mb-3">
...
<!--                                    <div class="card-header">
                                    ...
                                    <div class="card-header" style="background-color: #cddc39;">
                                        <h4 class="panel-title">
                                            <a href="#"> ADD LESSON  IN OTHER LANGUAGES </a>
                                            <span class="pull-right" style="cursor: pointer; color: #fff;"><i class="fa fa-ellipsis-h" style="font-size: 16px;" data-toggle="collapse" href="#collapse3"></i></span>
                                        </h4>
                                    </div>
                                        ...
                                        <div class="panel-body pd-10">
                                            <table id="example" class="table table-bordered " style="width:100%">
                                                    ...
                                                    foreach ($language as $k => $v) {
                                                        if ($v['language_id'] != 1) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="vr-line"><p class="i-field"><input name="lessonlangauge_title[<?php echo $v['language_id']; ?>]" id="<?php echo $shortname ?>" type="text" class="form-controls <?php echo $shortname ?>"   >
                                                                    </p>
                                                                </td>
                                                                <td> <textarea class="form-control" name="lessonlangauge_desc[<?php echo $v['language_id']; ?>]" id="<?php echo $descid; ?>" ></textarea></td>
                                                            </tr>
                                                           <?php
                                                            $kk++;
                                                        }
                                                ...
                                                <script>
                                                    ...
                                                    if ($v['language_id'] == 3) {?>  Tamil(); <?php }  if ($v['language_id'] == 4) { ?>
                                                        bengali();
