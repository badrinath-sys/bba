            ...
            <div class="col-md-12">
                ...
                <div class="my-info">
                    ...
                    <div class="row rnd-pd">
                        <form action="<?php echo base_url() . "Skill/updateskill"; ?>" class="form-horizontal" name="frmsubcatg" id="frmsubcatg" method="post" accept-charset="utf-8">
                            <div class="row pt-3">
                                <div class="col-md-3 mb-3">
                                 ...
                                 <div class="col-md-3 mb-3">
                                    ...
                                    <select name="groupe_id" id="groupe_id"  class="form-control select2"  required=""  style="width: 100%;">
                                        ...
                                        <option value="<?php echo $grouperesults1['group_id']; ?>" <?php if($grouperesults1['group_id']==$result[0]->bba_group_id){ ?> selected="" <?php } ?>><?php echo $grouperesults1['group_name']; ?>(<?php echo $grouperesults1['group_age']; ?>)</option>
                                            <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input class="form-control" type="text" name="skill_name" id="skill_name" value="<?php echo $result[0]->bba_skill_name; ?>" placeholder="Skill Name" required="">
                                </div>

                                <div class="col-md-3 mb-3">
                                    <label>Skill Description</label>
                                    <input class="form-control" type="text" name="skill_description" id="skill_description"  value="<?php echo $result[0]->bba_skill_description; ?>" placeholder="Skill Description" required="">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label>Total Lessons</label>
                                    <input class="form-control" type="text" name="total_lessons" id="total_lessons" placeholder="Total Lessons" required="" value="<?php echo $result[0]->bba_total_lessons; ?>">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label>Valid From</label>
                                    <input class="form-control" type="text" name="valid_from" id="valid_from"  placeholder="Valid From" required="" value="<?php echo date('Y-m-d', strtotime($result[0]->bba_skill_validfrom_date)); ?>">
                                </div>

                                <div class="col-md-3 mb-3">
                                    <label>Valid To</label>
                                    <input class="form-control" type="text" name="valid_to" id="valid_to"  placeholder="Valid To" required="" value="<?php echo date('Y-m-d', strtotime($result[0]->bba_skill_validto_date)); ?>">
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="is_active" id="is_active"  class="form-control select2"  required=""  style="width: 100%;">
                                        <option value="t" <?php if ($result[0]->bba_skill_isactive == true) { ?> selected <?php } ?>>Active</option>
                                        <option value="f" <?php if ($result[0]->bba_skill_isactive == false) { ?> selected <?php } ?>>InActive</option>
                                    </select>
                                </div>
                                    ...
                                    <div class="panel card-body ">
                                        <div class="card-header" style="background-color: #cddc39;">
                                            <h4 class="panel-title">
                                                <a href="#"> ADD COURSE  IN OTHER LANGUAGES </a>
                                                    ...
                                                    foreach ($language as $k => $v) {
                                                        if ($v['language_id'] != 1) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php
                                                                $langugroupname = $this->Skill_model->getskillnamelanguagewise($skillid, $v['language_id']);
                                                                ?>
                                                                <td class="vr-line"><p class="i-field"><input name="skilllangauge_title[<?php echo $v['language_id']; ?>]" id="<?php echo $shortname ?>" type="text" value="<?php echo $langugroupname[0]->bba_skill_language_name; ?>" class="form-controls <?php echo $shortname ?>"   >
                                                                    </p>
                                                                </td>
                                                                <td> <textarea class="form-control" name="skilllangauge_desc[<?php echo $v['language_id']; ?>]" id="<?php echo $descid; ?>"  ><?php echo $langugroupname[0]->bba_skill_language_description; ?></textarea></td>
                                                            </tr>
                                                            <?php
                                                            $kk++;
                                                        }
